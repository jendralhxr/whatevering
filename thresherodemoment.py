# python -u unloader.py  jfeunloader.mp4 bg.png 24000000000000 log.csv vid.mp4
...
vidout = cv.VideoWriter(sys.argv[5],cv.VideoWriter_fourcc(*'mp4v'), 24.0, [height, width])
